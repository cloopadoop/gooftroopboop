...
class SeqTrack : public GTBItem {
 public:
  SeqTrack(GTBSeq *parentSeqFile, uint32_t offset = 0, uint32_t length = 0, std::string name = "Track");
...
protected:
 ...
 public:
  ...
  int channel;
  int channelGroup;
  bool active;            //indicates whether a GTBSeq is loading this track
  long totalTicks;
  int infiniteLoops;
